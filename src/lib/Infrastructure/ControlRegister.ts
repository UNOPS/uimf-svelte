...
import * as Boolean from '../Inputs/Boolean/Boolean.svelte';
...
import * as ProgressTracker from '../Outputs/ProgressTracker.svelte';
...
defaultControlRegister.registerInputComponent('boolean', Boolean);
